...
type HeaderSecondaryProps = HeaderSecondaryWrapperProps & {
    selectedMetric: keyof typeof Metrics;
...
const HeaderSecondary: React.FC<HeaderSecondaryProps> = memo(
                        ...
                        <div className={classes.withoutIcon}>
                            <HeaderWrapper title={title} withDate={withDate}>
                                <div className={classes.controls}>
                                    ...
                                    {!withoutHazardous ? (
                                        <div
                                            className={classes.hazardousSwitch}
                                        >
                                            <input
                                                id="showHazardous"
                                                type={"checkbox"}
    ...
    (prev, next) =>
        prev.selectedMetric === next.selectedMetric &&
        prev.showHazardous === next.showHazardous
);
...
const HeaderSecondaryWrapper: React.FC<HeaderSecondaryWrapperProps> = (
    wrapperProps
) => {
