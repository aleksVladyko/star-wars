...
export const getServerSideProps: GetServerSideProps<HomePageProps> = async ({
    ...
    res.setHeader(
        "Cache-Control",
        "public, s-maxage=43000, stale-while-revalidate=76000"
    );
    ...
    let nasaAsteroids = await getNasaAsteroids(
        initialDate,
        Number(process.env.DAYS_PER_REQUEST)
    );
    ...
    return {
        props: {
            apod,
            asteroids: resultAsteroids,
            initialDate: nasaAsteroids!.date.valueOf(),
        },
    };
};
